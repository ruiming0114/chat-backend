...
public class OfflineMessageBuilder implements MessageBuilder {

    private final Message message = new Message();

    @Override
    public void buildMessageType(JSONObject jsonObject) {
        message.setMessageType(MessageTypeEnum.OFFLINE);
    }
    ...
    public void buildContent(JSONObject jsonObject) {
        message.setContent(ContentTypeEnum.SYSTEM.getMessageContentFactory().newMessageContent("用户下线"));
    }
